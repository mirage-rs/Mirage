...
struct Registers {
    _0x0: BlockMmio<u32>,
    _0x4: BlockMmio<u32>,
    pub OPERATION_REG: BlockMmio<u32>,
    pub INT_ENABLE_REG: BlockMmio<u32>,
    pub INT_STATUS_REG: BlockMmio<u32>,
    pub CONFIG_REG: BlockMmio<u32>,
    pub IN_LL_ADDR_REG: BlockMmio<u32>,
    _0x1C: BlockMmio<u32>,
    _0x20: BlockMmio<u32>,
    pub OUT_LL_ADDR_REG: BlockMmio<u32>,
    _0x28: BlockMmio<u32>,
    _0x2C: BlockMmio<u32>,
    pub HASH_RESULT_REG: [BlockMmio<u8>; 0x20],
    _0x50: [BlockMmio<u8>; 0x20],
    pub CONTEXT_SAVE_CONFIG_REG: BlockMmio<u32>,
    _0x74: [BlockMmio<u8>; 0x18C],
    pub SHA_CONFIG_REG: BlockMmio<u32>,
    pub SHA_MSG_LENGTH_REG: BlockMmio<u32>,
    _0x208: BlockMmio<u32>,
    _0x20C: BlockMmio<u32>,
    _0x210: BlockMmio<u32>,
    pub SHA_MSG_LEFT_REG: BlockMmio<u32>,
    _0x218: BlockMmio<u32>,
    _0x21C: BlockMmio<u32>,
    _0x220: BlockMmio<u32>,
    _0x224: BlockMmio<u32>,
    _0x228: [BlockMmio<u8>; 0x58],
    pub AES_KEY_READ_DISABLE_REG: BlockMmio<u32>,
    pub AES_KEYSLOT_FLAGS: [BlockMmio<u32>; 0x10],
    _0x2C4: [BlockMmio<u8>; 0x3C],
    _0x300: BlockMmio<u32>,
    pub CRYPTO_REG: BlockMmio<u32>,
    pub CRYPTO_CTR_REG: [BlockMmio<u32>; 4],
    pub BLOCK_COUNT_REG: BlockMmio<u32>,
    pub AES_KEYTABLE_ADDR: BlockMmio<u32>,
    pub AES_KEYTABLE_DATA: BlockMmio<u32>,
    _0x324: BlockMmio<u32>,
    _0x328: BlockMmio<u32>,
    _0x32C: BlockMmio<u32>,
    pub CRYPTO_KEYTABLE_DST_REG: BlockMmio<u32>,
    _0x334: [BlockMmio<u8>; 0xC],
    pub RNG_CONFIG_REG: BlockMmio<u32>,
    pub RNG_SRC_CONFIG_REG: BlockMmio<u32>,
    pub RNG_RESEED_INTERVAL_REG: BlockMmio<u32>,
    _0x34C: [BlockMmio<u8>; 0xB4],
    pub RSA_CONFIG: BlockMmio<u32>,
    pub RSA_KEY_SIZE_REG: BlockMmio<u32>,
    pub RSA_EXP_SIZE_REG: BlockMmio<u32>,
    pub RSA_KEY_READ_DISABLE_REG: BlockMmio<u32>,
    pub RSA_KEYSLOT_FLAGS: [BlockMmio<u32>; 2],
    _0x418: BlockMmio<u32>,
    _0x41C: BlockMmio<u32>,
    pub RSA_KEYTABLE_ADDR: BlockMmio<u32>,
    pub RSA_KEYTABLE_DATA: BlockMmio<u32>,
    pub RSA_OUTPUT: [BlockMmio<u8>; 0x100],
    _0x528: [BlockMmio<u8>; 0x2D8],
    pub FLAGS_REG: BlockMmio<u32>,
    pub ERR_STATUS_REG: BlockMmio<u32>,
    _0x808: BlockMmio<u32>,
    pub SPARE_0: BlockMmio<u32>,
    _0x810: BlockMmio<u32>,
    _0x814: BlockMmio<u32>,
    _0x818: BlockMmio<u32>,
    _0x81C: BlockMmio<u32>,
    _0x820: [BlockMmio<u8>; 0x17E0],
}
